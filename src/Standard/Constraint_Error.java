...
public final class Constraint_Error extends com.adacore.ajis.NativeException implements com.adacore.ajis.internal.ada.AdaException {
   ...
   Ada.Exceptions.Exception_Occurrence Id_JNI_252;

   private Constraint_Error (String message, int [] addr) {
      super (message);
      Id_JNI_252 = new Ada.Exceptions.Exception_Occurrence (new com.adacore.ajis.internal.ada.AdaAccess (addr));
      Id_JNI_252.myAllocator = com.adacore.ajis.IProxy.Allocator.DYNAMIC;
      Id_JNI_252.myOwner = com.adacore.ajis.IProxy.Owner.PROXY;
   }

   public Constraint_Error (Standard.AdaString message) {
   ...
   static public Ada.Exceptions.Exception_Occurrence createOccurrence (Standard.AdaString Message) {
      ...
      try {
         Standard.AdaString Id_JNI_255 = Message;
         if (Id_JNI_255 == null) {
            throw new com.adacore.ajis.NativeException ("null not allowed for Message");
         }
         int [] Id_JNI_262;
         Standard.AdaString Id_JNI_263 = Id_JNI_255;
         ...
         Ada.Exceptions.Exception_Occurrence Id_JNI_269;
         if (com.adacore.ajis.internal.ada.AdaAccess.isNull (Id_JNI_268)) {
            Id_JNI_269 = null;
         } else {
            Id_JNI_269 = new Ada.Exceptions.Exception_Occurrence (new com.adacore.ajis.internal.ada.AdaAccess (Id_JNI_268));
         }
         Ada.Exceptions.Exception_Occurrence Id_JNI_270 = Id_JNI_269;
         if (Id_JNI_270 != null) {
            Id_JNI_270.myAllocator = com.adacore.ajis.IProxy.Allocator.DYNAMIC;
         }
         Ada.Exceptions.Exception_Occurrence Id_JNI_273 = Id_JNI_270;
         return Id_JNI_273;
      } finally {
