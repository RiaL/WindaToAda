...
package body JNI_Binding.Standard_JNI.Program_Error_JNI is 
   ...
   begin
      declare
         Id_JNI_280 : JNI_Binding.Standard_JNI.Id_JNI_51.Object_Pointer := JNI_Binding.Standard_JNI.Id_JNI_51.To_Object_Pointer (Id_JNI_1, Message);
         Id_JNI_285 : constant System.Address := JNI_Binding.Standard_JNI.Id_JNI_51.Get_Address (Id_JNI_280);
         ...
         Id_JNI_284 : JNI_Binding.Standard_JNI.Id_JNI_51.Array_Pointer_Cst;
      begin
         if AJIS.Internal.Java."=" (Id_JNI_280.Kind, AJIS.Internal.Java.Static) then
            ...
            Id_JNI_284 := JNI_Binding.Standard_JNI.Id_JNI_51.Array_Pointer_Cst (Id_JNI_280.General_Pointer);
         else
            Id_JNI_284 := JNI_Binding.Standard_JNI.Id_JNI_51.Array_Pointer_Cst (Id_JNI_280.Constant_Pointer);
         end if;
         declare
...
begin
   null;
   AJIS.Internal.Java.Reference_Exception (Standard.Program_Error'Identity, "Standard/Program_Error");
